...
6. Disable StellarCore's `Parallel Model Loader` (either in-game through the mod menu or by editing the config file)
...
7. Disable StellarCore's `Parallel Model Loader`, `B:EnergyCalculatorLegImprovements`, `B:EnergyNetLocalImprovements`, `B:GetIoAndSubTileEnergyNetLocalImprovements`, `B:GridDataImprovements` and `B:GridImprovements` (either in-game through the mod menu or by editing the config file)
...
6. Make sure you have all of [these mods](https://github.com/Radk6/MC-Optimization-Guide/blob/main/mods-n-stuff/1.12.2.md) installed
7. Disable StellarCore's `Parallel Model Loader` (either in-game through the mod menu or by editing the config file)
